...
import {ReflectionSource,ReflectionMobileSource} from '../../app/w/[token]/ClassroomApp';
...
createRoot(document.getElementById('root')!).render(<ThemeBoundary className={pageStyles.root}>{innerWidth>900?<ReflectionSource {...props} open={()=>{}}/>:<ReflectionMobileSource {...props} active="reflection" growthRequest={{studentId:"",sequence:0}} activeClass={data.rosterClasses![0]} open={()=>{}}/>}</ThemeBoundary>);
