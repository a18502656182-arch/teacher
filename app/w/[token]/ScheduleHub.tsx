...
export function ScheduleHub({ data, update, save, readOnly }: { data: ClassroomData; update: (fn: (d: ClassroomData) => ClassroomData) => void; save: () => Promise<boolean>; readOnly: boolean }) {
  ...
  return <div className="schedule-hub">
    ...
    {view === "class" ? <CourseSchedule data={data} update={update} save={save} readOnly={readOnly} /> : <TeacherAgenda data={data} update={update} save={save} readOnly={readOnly} />}
  </div>;
}
