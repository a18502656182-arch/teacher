...
export function ScheduleHub({ data, update }: { data: ClassroomData; update: (fn: (d: ClassroomData) => ClassroomData) => void }) {
  ...
  return <div className="schedule-hub">
    ...
    {view === "class" ? <CourseSchedule data={data} update={update} /> : <TeacherAgenda data={data} update={update} />}
  </div>;
}
