...
export function Dialog({ open, title, children, footer, busy = false, dirty = false, size = 'default', onRequestClose }: {
  open: boolean; title: string; children: ReactNode; footer?: ReactNode;
  busy?: boolean; dirty?: boolean; size?: 'default' | 'wide'; onRequestClose: (reason: CloseReason) => void;
}) {
  ...
  return <dialog ref={ref} className={styles.dialog} aria-labelledby={heading} data-size={size}
